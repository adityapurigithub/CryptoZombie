...
const Section10 = () => {
  return (
    <div className="section10 flex flex-col-reverse md:flex-row justify-center items-center gap-5 my-10">
      <div className="flex justify-center md:p-32 ">
        <img src="https://cryptozombies.io/images/level-complete%201.png" />
      </div>
      <div className="flex flex-col items-start md:w-1/2 px-9">
